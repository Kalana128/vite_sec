    ...
    <div className="flex">
      ...
      <nav className=" h-screen bg-gray-100 p-4 overflow-y-auto w-[18%]">
        ...
        <ul className="list-disc list-inside space-y-3">
          ...
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 8 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(8)}>Age Restriction Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 9 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(9)}>Notification Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 9 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(9)}>Email Marketing Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 9 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(9)}>Cancellation Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 10 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(10)}>Liability Waiver Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 10 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(10)}>Prohibited Activities Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 10 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(10)}>User Responsibility Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 11 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(11)}>Service Disruption Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 11 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(11)}>Mobile App Policy (if applicable)</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 11 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(11)}>Browser Compatibility Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 12 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(12)}>External Payment Processor Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 12 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(12)}>Multi-Language Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 12 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(12)}>Accessibility Feedback Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 13 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(13)}>GDPR Compliance Policy (for EU users)</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 13 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(13)}>Fair Use Policy</li>
          <li className={`text-left text-sm hover:bg-blue-100 hover:text-blue-600 py-2 px-2 rounded-lg transition-colors cursor-pointer focus:bg-blue-100 focus:text-blue-600 ${
                page === 13 ? 'font-bold bg-blue-50 text-blue-600' : ''
              }`}onClick={()=> setPage(13)}>Newsletter Subscription Policy</li>
      ...
      <div className="flex-1 p-10">
        ...
        {page != 14 && (<div className=' my-7 float-right py-3 px-8 text-center text-white font-semibold text-lg mr-9 bg-blue-600 rounded-xl cursor-pointer hover:bg-opacity-80' onClick={() => setPage(page+1)}>Next</div>)}
