...
//   return (
//     <div>
//       <h3 className="text-xl font-semibold mt-6">7. Anti-Fraud and Whistleblower Policy</h3>
//       <p><strong>Purpose:</strong> To establish a policy for reporting fraudulent activities or misconduct within the organization without fear of retaliation.</p>
//       <p><strong>Policy:</strong></p>
//       <ul className="list-decimal list-inside mb-4">
//         <li><strong>Reporting Procedures:</strong> Employees are encouraged to report any suspected fraudulent activities, unethical behavior, or violations of company policy to management or through designated reporting channels.</li>
//         <li><strong>Confidentiality:</strong> All reports will be treated confidentially, and the identity of whistleblowers will be protected to the fullest extent possible.</li>
//         <li><strong>No Retaliation:</strong> Retaliation against any employee for reporting in good faith is strictly prohibited. Employees found to be retaliating against whistleblowers will face disciplinary action.</li>
//       </ul>
//       <p><strong>Enforcement:</strong> Violations of this policy will result in disciplinary action and may lead to termination.</p>

//       <h3 className="text-xl font-semibold mt-6">8. Conflict of Interest Policy</h3>
//       <p><strong>Purpose:</strong> To prevent conflicts of interest that could harm the organization or its stakeholders.</p>
//       <p><strong>Policy:</strong></p>
//       <ul className="list-decimal list-inside mb-4">
//         <li><strong>Disclosure:</strong> Employees must disclose any potential conflicts of interest to management immediately, including personal relationships or financial interests that may interfere with their job duties.</li>
//         <li><strong>External Employment:</strong> Employees must seek written approval before engaging in any external employment or business activities that could conflict with their responsibilities to the company.</li>
//         <li><strong>Gifts and Favors:</strong> Employees should avoid accepting gifts or favors from individuals or entities doing business with the company unless they are of nominal value and do not influence decision-making.</li>
//       </ul>
//       <p><strong>Enforcement:</strong> Failure to disclose conflicts of interest or violations of this policy may result in disciplinary action, including termination.</p>

//       <h3 className="text-xl font-semibold mt-6">9. Non-Disclosure Agreement (NDA) Policy</h3>
//       <p><strong>Purpose:</strong> To protect sensitive information and intellectual property from unauthorized disclosure.</p>
//       <p><strong>Policy:</strong></p>
//       <ul className="list-decimal list-inside mb-4">
//         <li><strong>Confidential Information:</strong> Employees may have access to confidential information, including trade secrets, business plans, and client data. All employees must sign an NDA upon employment and maintain confidentiality at all times.</li>
//         <li><strong>Use of Information:</strong> Confidential information must only be used for business purposes and must not be shared with unauthorized individuals or organizations.</li>
//         <li><strong>Return of Materials:</strong> Upon termination of employment, employees must return all company property, including confidential materials, and must not retain copies.</li>
//       </ul>
//       <p><strong>Enforcement:</strong> Breach of the NDA will result in disciplinary action, which may include legal action and termination of employment.</p>
//     </div>
//   )
// }
