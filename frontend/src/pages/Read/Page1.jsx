...
//       <ul className="list-decimal list-inside mb-4 text-lg pl-8">
//         <li className='mt-3 text-lg'><strong>Access Control:</strong> Employees are granted access to company systems based on role-specific needs. All access is protected by multi-factor authentication (MFA) and strong password policies (minimum 12 characters with a mix of uppercase, lowercase, numbers, and symbols).</li>
//         <li className='mt-3 text-lg'><strong>Data Protection:</strong> Employees must ensure that client data is handled and stored securely, following the Data Protection Act and GDPR compliance requirements. Any unauthorized access, modification, or disclosure of data is prohibited.</li>
//         <li className='mt-3 text-lg'><strong>Incident Reporting:</strong> All security incidents, including data breaches, phishing attempts, or other suspicious activities, must be reported immediately to the IT security team.</li>
//         <li className='mt-3 text-lg'><strong>Device Security:</strong> Employees are required to use only authorized devices for work-related activities. Personal devices used to access company systems must comply with security protocols, including encryption and VPN usage.</li>
//       </ul>
//       <p className=' text-lg'><strong>Enforcement:</strong> Violations of this policy will result in disciplinary actions, up to and including termination of employment.</p>
//       </div>
...
export default function Page1() {
  return (
    <div>
      ...
      <h3 className="text-3xl font-semibold mt-16 text-blue-600">2. Acceptable Use Policy</h3>
      <p className= 'p-3 text-lg '><strong>Purpose:</strong> To establish guidelines for the proper use of company resources, including computers, networks, and data.</p>
      <p><strong className=' text-lg pl-5'>Policy:</strong></p>
      <div className='pl-3'>
      <ul className="list-decimal list-inside mb-4">
        <li className='mt-3 text-lg'><strong>Resource Use:</strong> Company resources must be used exclusively for business purposes. Personal use of company equipment, systems, or internet access is permitted only on a limited basis and must not interfere with work performance or security.</li>
        <li className='mt-3 text-lg'><strong>Prohibited Actions:</strong> Employees are prohibited from downloading or installing unauthorized software, accessing inappropriate content, or engaging in activities that may harm the integrity of the company’s systems or reputation.</li>
        <li className='mt-3 text-lg'><strong>Network Usage:</strong> Employees must avoid excessive or inappropriate use of the company’s network resources. Peer-to-peer file-sharing, unauthorized media streaming, and the transfer of large personal files are strictly prohibited.</li>
      </ul>
      <p className=' text-lg'><strong>Enforcement:</strong> Non-compliance with this policy will result in penalties, including revocation of system access or disciplinary measures.</p>
      </div>
